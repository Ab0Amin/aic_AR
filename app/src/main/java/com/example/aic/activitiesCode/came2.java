...
//
//        try {
//            file = File.createTempFile("cccgg","");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
////                Uri.parse(Environment.DIRECTORY_DOWNLOADS+"/cat/mesh_cat.glft"),
//                Uri.parse(R.raw.uderobj2),
//                RenderableSource.SourceType.GLTF2);
//
//        RenderableSource h = bul.setScale(1f)  // Scale the original model to 50%.
//                .setRecenterMode(RenderableSource.RecenterMode.ROOT)
//                .build();
//
//            File files = new File(Environment.getExternalStorageDirectory().toString()+"/a");
//            File[] n = files.listFiles();
//
//        dowenloadedModel = ModelRenderable.builder()
//                .setSource(this,h)
////                .setRegistryId(Environment.DIRECTORY_DOWNLOADS)
//                .build();
//        ;
//
